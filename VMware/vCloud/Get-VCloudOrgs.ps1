...
try {
    ...
    if ($AcceptAllCertificates) {
        $ScriptOut = & "${FILE_DIR}Search-VCloud" -Server $Server -Type "organization" -ResultType "OrgRecord" -Filter $Filter -AuthorizationToken $AuthorizationToken -AcceptAllCertificates
    } else {
