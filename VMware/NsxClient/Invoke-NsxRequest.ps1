...
.DESCRIPTION
    ...
    Changelog:
                v2.0.1, 2020-10-20, David Wettstein: Add function blocks.
...
process {
    ...
    try {
        ...
        if ([String]::IsNullOrEmpty($AuthorizationToken)) {
            $AuthorizationToken = & "${FILE_DIR}Connect-Nsx" -Server $Server -ApproveAllCertificates:$ApproveAllCertificates
        }
