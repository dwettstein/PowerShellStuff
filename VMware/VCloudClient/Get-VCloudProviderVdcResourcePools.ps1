...
.DESCRIPTION
    ...
    Filename:   Get-VCloudProviderVdcResourcePools.ps1
...
process {
    ...
    try {
        ...
        [Xml] $Response = & "${FILE_DIR}Invoke-VCloudRequest" -Server $Server -Method "GET" -Endpoint "/api/admin/extension/providervdc/$ProviderVdcId/resourcePools" -AuthorizationToken $AuthorizationToken -ApproveAllCertificates:$ApproveAllCertificates
